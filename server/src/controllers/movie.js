...
module.exports = (db_pool) => {
    return {
        ...
        get_movies_recommendations_page: async (user_id, offset, limit) => {
            console.log("\n[movie]: getting reco")
            const request = `
            SELECT
                movies.id,
        ...
        search_movies_page : async (user_id, query_term, minimum_rating, genre, quality, min_year, max_year, language, asc_or_desc, sort_by, offset, limit) => {
